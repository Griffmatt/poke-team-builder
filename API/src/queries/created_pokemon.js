...
const getAllPokemonOnTeam = 'SELECT created_pokemon.pokemon_name, created_pokemon.id, pokemon_on_team.team_id as teams FROM created_pokemon INNER JOIN pokemon_on_team ON created_pokemon.id = pokemon_on_team.created_pokemon_id'
